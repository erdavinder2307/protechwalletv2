...
import 'income_category_model.dart';
export 'income_category_model.dart';

class IncomeCategoryWidget extends StatefulWidget {
...
class _IncomeCategoryWidgetState extends State<IncomeCategoryWidget> {
  late IncomeCategoryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IncomeCategoryModel());
  }
